...
[![GitHub Marketplace](https://img.shields.io/badge/marketplace-easy--npm--publish-blue?logo=github)](https://github.com/marketplace/actions/easy-npm-publish)
...
| `registry-token`                   | `string`  | An auth token with access to publish to the registry. If one is not provided, OIDC auth must be configured for the publish to work.                                                                                                                                                                                                       |
